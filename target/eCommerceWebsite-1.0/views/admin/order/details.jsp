...
<html lang="en">
    ...
    <body>
        ...
        <script type="text/javascript">
            document.getElementById("title").innerText == "delivered"
                ? (document.getElementById("title").innerText =
                      "ĐƠN HÀNG CHI TIẾT (ĐÃ GIAO)")
                : (document.getElementById("title").innerText =
                      "ĐƠN HÀNG CHI TIẾT (ĐANG GIAO)");
            document
                .getElementById("back")
