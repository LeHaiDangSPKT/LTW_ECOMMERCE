						...
						<div class="sign-in-from bg-primary rounded">
							...
							<form class="mt-4 form-text">
								<div class="form-group d-flex">
									<div class="mr-1 w-50">
										<label for="exampleInputEmail1">Họ</label> <input type="text"
											class="form-control"
								...
								<div class="form-group">
									<label for="exampleInputEmail2">CMND/Căn cước công dân</label> <input
								...
								<div class="d-inline-block w-100">
									<div
										...
										<input type="checkbox" class="custom-control-input"
											...
											class="custom-control-label" for="customCheck1">Tôi chấp nhận
								...
								<div class="sign-info text-center">
									...
									<span class="text-dark d-inline-block line-height-2">Bạn đã có tài khoản ? <a href="sign-in.html" class="text-white">Đăng nhập</a>
									</span>
								</div>
							</form>
						</div>
